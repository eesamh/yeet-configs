...
6. Once fixes are implemented, run the relevant checks locally to verify. Discover the correct check commands from `AGENTS.md`, `package.json`, or `pyproject.toml` in the affected repo — do not guess.
7. Run `/review` to review, commit, and push the fixes.
